...
let SparepartController = class SparepartController {
    ...
    updated(req, res) {
        return res.status(common_1.HttpStatus.CREATED).json('updated');
    }
    list(req, res) {
        return res.status(common_1.HttpStatus.OK).json('list');
    }
    detail(req, res) {
        return res.status(common_1.HttpStatus.OK).json('detail');
    }
    destory(req, res) {
        return res.status(common_1.HttpStatus.OK).json('destory');
    }
};
...
], SparepartController.prototype, "created", null);
__decorate([
    (0, common_1.Post)(':id'),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Res)()),
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", void 0)
], SparepartController.prototype, "updated", null);
__decorate([
    (0, common_1.Get)(),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Res)()),
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", void 0)
], SparepartController.prototype, "destory", null);
